	...
	indicator.innerHTML = `
				<div class="flex items-center justify-between">
					<div class="flex items-center">
						...
						<span class="text-sm text-blue-800">Draft data has been restored from your previous session.</span>
					</div>
					<button type="button" onclick="clearDraft(this)" class="text-blue-600 hover:text-blue-800 text-sm underline">
						Clear Draft
					</button>
				</div>
			`;
